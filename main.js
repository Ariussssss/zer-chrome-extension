const ZER_CONFIG = {
  regUri: {
    b: {
      ...
      uri: "https://search.bilibili.com/all?keyword=__keyword__&from_source=nav_search_new",
    },
    bf: {
    ...
    gs: {
      description: "gs: github star",
      uri: "https://github.com/Ariussssss?tab=stars",
    },
    j: {
      description: "j: juejin",
      uri: "https://juejin.cn/search?query=__keyword__&type=0",
    },
    l: {
      description: "l: longman",
      uri: "https://www.ldoceonline.com/dictionary/__keyword__",
    },
    p: {
      description: "p: pix",
    ...
    tc: {
      ...
      uri: "https://translate.google.cn/#view=home&op=translate&sl=en&tl=zh-CN&text=__keyword__",
    },
    te: {
      description: "te: gooogle translate to English",
      uri: "https://translate.google.cn/#view=home&op=translate&sl=zh-CN&tl=en&text=__keyword__",
    },
    v: {
      description: "v: v2ex",
    ...
    y: {
      ...
      uri: "https://www.youtube.com/results?search_query=__keyword__&page=&utm_source=opensearch",
    },
    z: {
      description: "z: zhihu",
